/**
 * pxpl - PNG LSB Steganography Tool GUI
 * MIT License
 * 
 * Windows GUI interface for the steganography tool
 */
...
void CreateControls(HWND hwnd) {
    ...
    g_hCoverEdit = CreateWindow("EDIT", "", WS_VISIBLE | WS_CHILD | WS_BORDER,
    ...
    CreateWindow("STATIC", "Data:", WS_VISIBLE | WS_CHILD,
                20, y, 80, 20, hwnd, NULL, NULL, NULL);
    g_hPayloadEdit = CreateWindow("EDIT", "", WS_VISIBLE | WS_CHILD | WS_BORDER,
    ...
    CreateWindow("STATIC", "Output:", WS_VISIBLE | WS_CHILD,
                20, y, 80, 20, hwnd, NULL, NULL, NULL);
    g_hOutputEdit = CreateWindow("EDIT", "", WS_VISIBLE | WS_CHILD | WS_BORDER,
...
void SetMode(bool extractMode) {
    ...
    if (extractMode) {
        ...
        ShowWindow(GetDlgItem(g_hWnd, ID_BROWSE_OUTPUT), SW_HIDE);
        ...
        ShowWindow(GetDlgItem(g_hWnd, ID_BROWSE_OUTPUT), SW_SHOW);
